...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"grouped-load-more.tsx":[function(require,module,exports) {
"use strict";
...
var useGroupedUsers = function useGroupedUsers(count) {
  var allUsers = react_1.useMemo(function () {
    return new Array(count).fill(true).map(getUser).sort(sortUser);
  }, [count]);
...
function App() {
  ...
  return /*#__PURE__*/React.createElement(src_1.GroupedVirtuoso, {
    ...
    overscan: 400,
    endReached: function endReached(value) {
      console.log(value);
      loadMore();
    },
    itemContent: function itemContent(index) {
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, users[index].initials), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, users[index].name)), /*#__PURE__*/React.createElement("div", null, users[index].description));
    }
  });
}
