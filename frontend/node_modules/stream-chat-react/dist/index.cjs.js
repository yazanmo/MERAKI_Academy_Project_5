...
var QuotedMessage = function () {
    ...
    if (!quotedMessageText && !quotedMessageAttachment)
        return null;
    return (React__default['default'].createElement("div", { className: "" + (isMyMessage() ? 'quoted-message mine' : 'quoted-message') },
        quoted_message.user && (React__default['default'].createElement(Avatar, { image: quoted_message.user.image, size: 20, user: quoted_message.user })),
...
var UnMemoizedMessageTextComponent = function (props) {
    ...
    var _e = useMessageContext(), message = _e.message, onMentionsClickMessage = _e.onMentionsClickMessage, onMentionsHoverMessage = _e.onMentionsHoverMessage, _f = _e.renderText, renderText$1 = _f === void 0 ? renderText : _f, unsafeHTML = _e.unsafeHTML;
...
var useCooldownTimer = function () {
    ...
    var _a = React.useState(), cooldownRemaining = _a[0], setCooldownRemaining = _a[1];
    React.useEffect(function () {
...
var QuotedMessagePreview = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: 'quoted-message-preview' },
        ...
        React__default['default'].createElement("div", { className: 'quoted-message-preview-content' },
            quotedMessage.user && (React__default['default'].createElement(Avatar, { image: quotedMessage.user.image, size: 20, user: quotedMessage.user })),
...
var MessageSimpleWithContext = function (props) {
    ...
    var _a = useComponentContext(), Attachment = _a.Attachment, _b = _a.Avatar, Avatar$1 = _b === void 0 ? Avatar : _b, _c = _a.EditMessageInput, EditMessageInput = _c === void 0 ? EditMessageForm : _c, _d = _a.MessageDeleted, MessageDeleted$1 = _d === void 0 ? MessageDeleted : _d, _e = _a.MessageOptions, MessageOptions$1 = _e === void 0 ? MessageOptions : _e, _f = _a.MessageRepliesCountButton, MessageRepliesCountButton$1 = _f === void 0 ? MessageRepliesCountButton : _f, _g = _a.MessageStatus, MessageStatus$1 = _g === void 0 ? MessageStatus : _g, _h = _a.MessageTimestamp, MessageTimestamp$1 = _h === void 0 ? MessageTimestamp : _h, _j = _a.ReactionSelector, ReactionSelector$1 = _j === void 0 ? ReactionSelector : _j, _k = _a.ReactionsList, ReactionsList$1 = _k === void 0 ? ReactionsList : _k;
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement("div", { className: ("\n\t\t\t\t\t\t" + messageClasses + "\n\t\t\t\t\t\tstr-chat__message--" + message.type + "\n\t\t\t\t\t\tstr-chat__message--" + message.status + "\n\t\t\t\t\t\t" + (message.text ? 'str-chat__message--has-text' : 'has-no-text') + "\n\t\t\t\t\t\t" + (hasAttachment ? 'str-chat__message--has-attachment' : '') + "\n            " + (hasReactions && isReactionEnabled ? 'str-chat__message--with-reactions' : '') + "\n            " + (message.pinned ? 'pinned-message' : '') + "\n\t\t\t\t\t").trim(), key: message.id, ref: messageWrapperRef },
            ...
            React__default['default'].createElement("div", { className: 'str-chat__message-inner', "data-testid": 'message-inner', onClick: message.status === 'failed' && message.errorStatusCode !== 403
                ...
                message.attachments && (React__default['default'].createElement(Attachment, { actionHandler: handleAction, attachments: message.attachments })),
                message.text && React__default['default'].createElement(MessageText, null),
...
var UnMemoizedChannelPreviewMessenger = function (props) {
    var active = props.active, _a = props.Avatar, Avatar$1 = _a === void 0 ? Avatar : _a, channel = props.channel, displayImage = props.displayImage, displayTitle = props.displayTitle, latestMessage = props.latestMessage, setActiveChannel = props.setActiveChannel, unread = props.unread, watchers = props.watchers;
    ...
    return (React__default['default'].createElement("button", { className: "str-chat__channel-preview-messenger " + unreadClass + " " + activeClass, "data-testid": 'channel-preview-button', onClick: onSelectChannel, ref: channelPreviewButton },
        React__default['default'].createElement("div", { className: 'str-chat__channel-preview-messenger--left' },
            React__default['default'].createElement(Avatar$1, { image: displayImage, name: displayTitle, size: 40 })),
...
var UnMemoizedChannelSearch = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: 'str-chat__channel-search' },
        React__default['default'].createElement("input", { onChange: function (event) {
...
var Streami18n = /** @class */ (function () {
    ...
    function Streami18n(options) {
        ...
        this.translations = {
            ...
            nl: (_g = {}, _g[defaultNS] = nlTranslations, _g),
            pt: (_h = {}, _h[defaultNS] = ptTranslations, _h),
            ru: (_j = {}, _j[defaultNS] = ruTranslations, _j),
            tr: (_k = {}, _k[defaultNS] = trTranslations, _k),
        };
        /**
        ...
        if (translationsForLanguage) {
            this.translations[this.currentLanguage] = (_l = {},
                _l[defaultNS] = this.translations[this.currentLanguage] &&
        ...
        if (!this.translations[this.currentLanguage]) {
            this.translations[this.currentLanguage] = (_m = {},
                _m[defaultNS] = {},
                _m);
        }
        this.i18nextConfig = {
...
var UnMemoizedFixedHeightMessage = function (props) {
    var _a, _b, _c, _d;
    var groupedByUser = props.groupedByUser, propMessage = props.message;
    var theme = useChatContext().theme;
    var contextMessage = useMessageContext().message;
    var _e = useComponentContext().MessageDeleted, MessageDeleted$1 = _e === void 0 ? MessageDeleted : _e;
    var userLanguage = useTranslationContext().userLanguage;
    var message = propMessage || contextMessage;
...
var MessageWithContext = function (props) {
    var canPin = props.canPin, propMessage = props.Message, message = props.message, _a = props.messageActions, messageActions = _a === void 0 ? Object.keys(MESSAGE_ACTIONS) : _a, propOnUserClick = props.onUserClick, propOnUserHover = props.onUserHover, userRoles = props.userRoles;
    ...
    return (React__default['default'].createElement(MessageProvider, { value: messageContextValue },
        React__default['default'].createElement(MessageUIComponent, null)));
};
...
var MessageCommerceWithContext = function (props) {
    ...
    var _f = useComponentContext(), Attachment = _f.Attachment, _g = _f.Avatar, Avatar$1 = _g === void 0 ? Avatar : _g, _h = _f.MessageDeleted, MessageDeleted$1 = _h === void 0 ? MessageDeleted : _h, _j = _f.MessageRepliesCountButton, MessageRepliesCountButton$1 = _j === void 0 ? MessageRepliesCountButton : _j, _k = _f.MessageOptions, MessageOptions$1 = _k === void 0 ? MessageOptions : _k, _l = _f.MessageTimestamp, MessageTimestamp$1 = _l === void 0 ? MessageTimestamp : _l, _m = _f.ReactionSelector, ReactionSelector$1 = _m === void 0 ? ReactionSelector : _m, _o = _f.ReactionsList, ReactionsList$1 = _o === void 0 ? ReactionsList : _o;
    var hasAttachment = messageHasAttachments(message);
    var hasReactions = messageHasReactions(message);
...
var MessageLivestreamWithContext = function (props) {
    ...
    var clearEditingState = props.clearEditingState, editing = props.editing, groupStyles = props.groupStyles, handleAction = props.handleAction, handleOpenThread = props.handleOpenThread, handleRetry = props.handleRetry, initialMessage = props.initialMessage, isReactionEnabled = props.isReactionEnabled, message = props.message, messageWrapperRef = props.messageWrapperRef, onMentionsClickMessage = props.onMentionsClickMessage, onMentionsHoverMessage = props.onMentionsHoverMessage, onReactionListClick = props.onReactionListClick, onUserClick = props.onUserClick, onUserHover = props.onUserHover, reactionSelectorRef = props.reactionSelectorRef, _k = props.renderText, renderText$1 = _k === void 0 ? renderText : _k, showDetailedReactions = props.showDetailedReactions, unsafeHTML = props.unsafeHTML;
    var _l = useComponentContext().QuotedMessage, QuotedMessage$1 = _l === void 0 ? QuotedMessage : _l;
    var _m = useComponentContext(), Attachment = _m.Attachment, _o = _m.Avatar, Avatar$1 = _o === void 0 ? Avatar : _o, _p = _m.EditMessageInput, EditMessageInput = _p === void 0 ? EditMessageForm : _p, _q = _m.MessageDeleted, MessageDeleted$1 = _q === void 0 ? MessageDeleted : _q, _r = _m.MessageRepliesCountButton, MessageRepliesCountButton$1 = _r === void 0 ? MessageRepliesCountButton : _r, _s = _m.PinIndicator, PinIndicator$1 = _s === void 0 ? PinIndicator : _s, _t = _m.ReactionsList, ReactionsList = _t === void 0 ? SimpleReactionsList : _t, _u = _m.ReactionSelector, ReactionSelector$1 = _u === void 0 ? ReactionSelector : _u;
...
var MessageTeamWithContext = function (props) {
    ...
    var _m = useComponentContext(), Attachment = _m.Attachment, _o = _m.Avatar, Avatar$1 = _o === void 0 ? Avatar : _o, _p = _m.EditMessageInput, EditMessageInput = _p === void 0 ? EditMessageForm : _p, _q = _m.MessageDeleted, MessageDeleted$1 = _q === void 0 ? MessageDeleted : _q, _r = _m.MessageRepliesCountButton, MessageRepliesCountButton$1 = _r === void 0 ? MessageRepliesCountButton : _r, _s = _m.MessageTimestamp, MessageTimestamp$1 = _s === void 0 ? MessageTimestamp : _s, _t = _m.PinIndicator, PinIndicator$1 = _t === void 0 ? PinIndicator : _t, _u = _m.QuotedMessage, QuotedMessage$1 = _u === void 0 ? QuotedMessage : _u, _v = _m.ReactionsList, ReactionsList = _v === void 0 ? SimpleReactionsList : _v, _w = _m.ReactionSelector, ReactionSelector$1 = _w === void 0 ? ReactionSelector : _w;
        ...
        React__default['default'].createElement("div", { className: "str-chat__message-team str-chat__message-team--" + firstGroupStyle + " str-chat__message-team--" + message.type + " " + (threadList ? 'thread-list' : '') + " str-chat__message-team--" + message.status + " " + (message.pinned ? 'pinned-message' : ''), "data-testid": 'message-team', ref: messageWrapperRef },
            ...
            React__default['default'].createElement("div", { className: 'str-chat__message-team-group' },
                ...
                React__default['default'].createElement("div", { className: "str-chat__message-team-content str-chat__message-team-content--" + firstGroupStyle + " str-chat__message-team-content--" + (message.text === '' ? 'image' : 'text'), "data-testid": 'message-team-content' },
                    ...
                    message.mml && React__default['default'].createElement(MML, { actionHandler: handleAction, align: 'left', source: message.mml }),
                    !message.text && message.attachments && (React__default['default'].createElement(Attachment, { actionHandler: handleAction, attachments: message.attachments })),
                    ((_k = message.latest_reactions) === null || _k === void 0 ? void 0 : _k.length) !== 0 && message.text !== '' && isReactionEnabled && (React__default['default'].createElement(ReactionsList, null)),
...
var VirtualizedMessageListWithContext = function (props) {
    ...
    var messageRenderer = React.useCallback(function (messageList, virtuosoIndex) {
        ...
        return (React__default['default'].createElement(Message, { message: message, Message: function () {
                var _a, _b;
                return (React__default['default'].createElement(MessageUIComponent, { groupedByUser: shouldGroupByUser &&
...
var ThreadInner = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: "str-chat__thread " + (fullWidth ? 'str-chat__thread--full' : '') },
        ...
        React__default['default'].createElement("div", { className: 'str-chat__thread-list', ref: messageList },
            React__default['default'].createElement(Message, __assign({ initialMessage: true, message: thread, Message: ThreadMessage, threadList: true }, additionalParentMessageProps)),
            React__default['default'].createElement(ThreadStart, null),
            React__default['default'].createElement(MessageList, __assign({ hasMore: threadHasMore, loadingMore: threadLoadingMore, loadMore: loadMoreThread, Message: ThreadMessage, messages: threadMessages || [], threadList: true }, additionalMessageListProps))),
