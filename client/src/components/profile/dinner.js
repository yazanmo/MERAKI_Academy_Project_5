...
const Dinner = ({ date }) => {
  ...
  useEffect(() => {
    axios
      .post(
        `${process.env.REACT_APP_BACKEND_SERVER}/dinner`,
        { date },
        {
          headers: {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        axios
                          .post(
                            `${process.env.REACT_APP_BACKEND_SERVER}/add/dinner`,
                            {
                              name,
                              calories,
                              date,
                        ...
                        <th>
                          <img
                            ...
                            onClick={() => {
                              axios
                                .delete(
                                  `${process.env.REACT_APP_BACKEND_SERVER}/dinner/${element.dinner_id}`,
                                  {
                                    headers: {
                                      authorization: "Bearer " + token,
                                    },
